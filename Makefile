#############################################################################
# Makefile for building: PixelPoiEditor
# Generated by qmake (3.0) (Qt 5.2.1)
# Project:  PixelPoiEditor.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -o Makefile PixelPoiEditor.pro
#############################################################################
...
Makefile: PixelPoiEditor.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile PixelPoiEditor.pro
...
dist: 
	@test -d .tmp/PixelPoiEditor1.0.0 || mkdir -p .tmp/PixelPoiEditor1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/PixelPoiEditor1.0.0/ && $(COPY_FILE) --parents widget.h Mode.hpp Count.hpp Image.hpp .tmp/PixelPoiEditor1.0.0/ && $(COPY_FILE) --parents main.cpp widget.cpp .tmp/PixelPoiEditor1.0.0/ && $(COPY_FILE) --parents widget.ui .tmp/PixelPoiEditor1.0.0/ && (cd `dirname .tmp/PixelPoiEditor1.0.0` && $(TAR) PixelPoiEditor1.0.0.tar PixelPoiEditor1.0.0 && $(COMPRESS) PixelPoiEditor1.0.0.tar) && $(MOVE) `dirname .tmp/PixelPoiEditor1.0.0`/PixelPoiEditor1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/PixelPoiEditor1.0.0
